...
// first, create an array with all our vertex attribute values:
  var vertices = new Float32Array([
    -0.8,  0.5, 0.0, 1.0,	// CAREFUL! I made these into 4D points/ vertices: x,y,z,w.
    -0.6, -0.0, 0.0, 1.0,	// new point!  (? What happens if I make w=0 instead of 1.0?)
    -0.8, -0.5, 0.0, 1.0,   
    -0.3, -0.2, 0.0, 1.0, 	  // new point!
    -0.05, -0.7, 0.0, 1.0,	   // 
     0.15, -0.2, 0.0, 1.0,   // new point!  (note we need a trailing comma here)
     0.6,  -0.45, 0.0, 1.0,  // Add many such points and then modify their x and y coordinates to place them at specific desired locations that help in depicting a star :)
     0.4,  -0.0, 0.0, 1.0,
     0.6,  0.5, 0.0, 1.0,
     0.1,  0.2, 0.0, 1.0,
     -0.1,  0.7, 0.0, 1.0,
